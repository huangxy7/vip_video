							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="http://huangxy.cn" target="_blank" title="huangxy的个人博客，技术分享、资源分享、疑难解答、最新技术，vue.js，php开发，Python爬虫，深度学习及爱好者提供一个信息交流、经验分享、互帮互助的平台">官方博客</a>
										</li>
										<li>
											<a href="<?php echo $aik['weibourl'];?>" target="_blank" title="huangxy的微博">huangxy微博</a>
										</li>
